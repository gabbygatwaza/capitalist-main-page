...
const CPLabConsultancy = () => {
  ...
  const message = encodeURIComponent("I want consultation service");
  window.open(`https://wa.me/250782689127?text=${message}`, '_blank');
};
  return (
    <>
      <Navbar />
          ...
          <section>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <div className="text-center">
                <button 
                  className="bg-red-600 text-white py-2 px-6 rounded-lg hover:bg-blue-700 transition duration-300"
